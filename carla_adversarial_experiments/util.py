...
def plot_one_result(memory_dir,window_size,dist,window_threshold):
    ...
    plt.savefig("./results/p_true_prediction_sticker_tau_"+window_threshold+"_T_"+window_size+".png",bbox_inches='tight')
    plt.close() 
    ...
    plt.xlabel("Probability Density Threshold",fontsize=18,weight="bold")
    plt.savefig("./results/p_false_prediction_sticker_tau_"+window_threshold+"_T_"+window_size+".png",bbox_inches='tight')
    plt.close() 