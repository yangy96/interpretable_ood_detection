...
class data:
    ...
    def compute_distance_batched(self, other_data_collection):
        ...
        lidar_collection = lidar_collection.to(self.device)
        numpy_lidar_distance_collection = self.compute_lidar_distance_batched(lidar_collection)
        numpy_lidar_distance_collection = numpy_lidar_distance_collection.to(device)
        print(numpy_lidar_distance_collection)
