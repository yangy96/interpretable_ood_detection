...
python3 -u main.py --predict_crash True --memory_dir ./memories/LIDAR_memories_0.3 \
...
python3 -u main.py --predict_crash True --memory_dir ./memories/LIDAR_memories_0.2 \
