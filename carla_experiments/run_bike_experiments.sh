...
python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.2  --test_carla_dir ./oods_bike \
...
python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.3  --test_carla_dir ./oods_bike \
