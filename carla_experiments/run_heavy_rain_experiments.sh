rm -f ./results/carla_oods_heavy_rain_exp_results.txt
...
python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.3   --initial_memory_threshold 0.3 --test_carla_dir ./test_carla/in_test \
--prob_threshold 0.78 --window_size 5 --window_threshold 5 --task heavy_rain

python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.3   --initial_memory_threshold 0.3 --test_carla_dir ./test_carla/oods_heavy_rain \
--prob_threshold 0.78 --window_size 5 --window_threshold 5 --task heavy_rain
