...
python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.2  --initial_memory_threshold 0.2 --test_carla_dir ./oods_night \
...
python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.3 --initial_memory_threshold 0.3 --test_carla_dir ./oods_night \
...
python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.2  --test_carla_dir ./oods_foggy \
...
python3 main.py --predict_carla True --memory_dir ./memories/carla_memories_10_0.3  --test_carla_dir ./oods_foggy \
